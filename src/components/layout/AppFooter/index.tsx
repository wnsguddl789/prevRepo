...
const AppFooterContainer = styled.div`
  ...
  padding: 10px 30px;
`;
const AppFooterListWrapper = styled.ul`
  display: flex;
`;
const AppFooterList = styled.li`
  font-size: 12px;
  margin-right: 10px;
...
`;
const AppFooterCardWrapper = styled.div`
  display: grid;
  grid-template-columns: 33% 33% 33%;
  margin: 30px 0;
`;
const AppFooterCard = styled.div`
  height: 10%;
  display: block;
  margin: 0 5px;
`;
const AppFooterCardHeader = styled.div`
  font-size: 12px;
  font-weight: 700;
`;
const AppFooterCardMain = styled.div`
  margin: 10px 0;
  font-size: 12px;
  color: rgba(0, 0, 0, 0.5);
  line-height: 1.6;
`;
const AppFooterDesc = styled.p`
